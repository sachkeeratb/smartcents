		...
		<>
			<CardContainer className='inter-var'>
				<CardBody className='bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto h-auto rounded-xl p-4 border'>
					...
					>
						Hi, my name is Manav. I&apos;m a high school student who is equipped
						with and has seen the importance of essential financial skills.{' '}
						<br /> As an aspiring leader in HB FBLC and HB&apos;s computer
						science clubs, I aim to leverage my mathematical and financial
						expertise to create workshops and literature that are both
						informative and fun for the community.
					</CardItem>
				</CardBody>
			</CardContainer>
			<CardContainer className='inter-var'>
				<CardBody className='bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto h-auto rounded-xl p-4 border'>
					...
					>
						...
						speaker, I strive to make financial literacy accessible and engaging
						through SmartCents.
					</CardItem>
				</CardBody>
			</CardContainer>
			<CardContainer className='inter-var'>
				<CardBody className='bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto h-auto rounded-xl p-4 border'>
					...
					>
						...
						currently attending Harold M. Brathwaite. I am interested in finance
						and being able to teach others about it. Through SmartCents, I hope
						to accomplish my goal and prepare youth for the financial world.
					</CardItem>
				</CardBody>
			</CardContainer>
		</>
			...
			<CardContainer className='inter-var'>
				<CardBody className='bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto h-auto rounded-xl p-4 border'>
					...
					<CardItem
						...
						className='text-neutral-500 text-sm max-w-[18rem] mt-2 justify-self-center text-center dark:text-neutral-300'
					>
						Hi, my name is Sachkeerat. I am passionate about technology and lead
						the IT efforts at SmartCents to ensure our platform runs smoothly
						and efficiently.
					</CardItem>
				</CardBody>
			</CardContainer>
			<CardContainer className='inter-var'>
				<CardBody className='bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto h-auto rounded-xl p-4 border'>
					...
					<CardItem
						...
						className='text-neutral-500 text-sm max-w-[18rem] mt-2 justify-self-center text-center dark:text-neutral-300'
					>
						Hi, my name is Mehar. I am dedicated to spreading financial literacy
						and ensuring our outreach and marketing efforts are impactful and
						far-reaching. Through SmartCents, I aim to connect with the
						community and promote financial education.
					</CardItem>
				</CardBody>
			</CardContainer>
		</>
